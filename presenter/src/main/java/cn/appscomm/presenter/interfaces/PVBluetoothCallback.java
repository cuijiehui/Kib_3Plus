...
public interface PVBluetoothCallback {
    enum BluetoothCommandType {
        ...
        L28T_SET_NAME_DATA,                                                                         //l28t设置名字
        L28T_SET_PRESET_SLEEP,                                                                       //l28t设置预设睡眠
        L28T_SET_SLEEP_COUNT,                                                                       //l28t睡眠条数
        L28T_SET_SLEEP_DATA,                                                                       //l28t睡眠数据
        L28T_SET_DEL_SLEEP_DATA,                                                                       //l28t删除睡眠数据
