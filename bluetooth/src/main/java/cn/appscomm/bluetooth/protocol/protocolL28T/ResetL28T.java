...
public class ResetL28T extends Leaf {
    /**
     * 构造器
     *
     ...
     */
    public ResetL28T(IBluetoothResultCallback iBluetoothResultCallback, byte[] content){
        /**
         * 因为L28T的命令格式是0x6E, 0x01, (byte) 0x03, 0x03, (byte) 0x8F
         * 用于判断所以只需要传用于判断是否是L28T的命令码
         */
        super(iBluetoothResultCallback, BluetoothCommandConstant.COMMAND_CODE_L28T_SET_RESET,BluetoothCommandConstant.ACTION_SET_CODE_L28T);
